...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary: 'Read shared group quota state, including authoritative-counter usage, remaining bytes, active/pending multiplier, and depletion state.',
        params: [{ name: 'name', in: 'path', type: 'string', desc: 'Group name (URL-encoded).' }],
      },
      {
        method: 'PUT',
        path: '/panel/api/clients/groups/quota/:name',
        summary: 'Update group quota configuration. Multiplier changes are pending until the next group reset/rebaseline and do not reprice existing usage.',
        params: [{ name: 'name', in: 'path', type: 'string', desc: 'Group name (URL-encoded).' }],
      ...
      },
      {
        ...
        summary: 'Reset group quota carry and membership bases, activate the pending multiplier, and re-enable only clients owned by this group quota.',
        params: [{ name: 'name', in: 'path', type: 'string', desc: 'Group name (URL-encoded).' }],
      },
      {
        method: 'HEAD',
