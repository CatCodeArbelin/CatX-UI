...
export const sections: readonly Section[] = [
  ...
  },
  {
    ...
    endpoints: [
      {
        method: 'GET',
        path: '/panel/api/policies/status',
        summary: 'Return policy data feature status.',
        response: '{ enabled, enforcement: false }',
      },
      {
        method: 'GET',
        path: '/panel/api/policies',
        summary: 'List policies.',
        response: '{ enabled, items }',
      },
      {
        method: 'POST',
        path: '/panel/api/policies',
        summary: 'Create a policy data record.',
        body: '{ name, description, spec, priority, enabled }',
        response: 'policy',
      },
      {
        method: 'GET',
        path: '/panel/api/policies/:id',
        summary: 'Read one policy data record.',
      ...
      },
      {
        method: 'PUT',
        path: '/panel/api/policies/:id',
        summary: 'Update one policy data record.',
        params: [{ name: 'id', in: 'path', type: 'integer' }],
        body: '{ name, description, spec, priority, enabled }',
        response: 'policy',
      },
      {
        method: 'DELETE',
        path: '/panel/api/policies/:id',
        summary: 'Delete a policy and its fork-owned assignments and overrides.',
        params: [{ name: 'id', in: 'path', type: 'integer' }],
      },
      {
        method: 'GET',
        path: '/panel/api/policies/assignments',
        summary: 'List client and group policy assignments.',
        response: '{ enabled, items }',
      },
      {
        method: 'POST',
        path: '/panel/api/policies/assignments',
        summary: 'Assign a policy to an existing upstream client or group.',
        body: '{ policyId, targetType, targetRef, priority, enabled }',
        response: 'assignment',
      },
      {
        method: 'DELETE',
        path: '/panel/api/policies/assignments/:id',
      ...
      {
        method: 'GET',
        path: '/panel/api/policies/overrides',
        summary: 'List explicit policy override metadata.',
        response: '{ enabled, items }',
      },
      {
        method: 'POST',
        path: '/panel/api/policies/overrides',
        summary: 'Create explicit override metadata.',
        body: '{ policyId, targetType, targetRef, scope, value, priority, enabled }',
        response: 'override',
      },
      {
        method: 'DELETE',
        path: '/panel/api/policies/overrides/:id',
        summary: 'Delete an explicit override.',
        params: [{ name: 'id', in: 'path', type: 'integer' }],
      },
      {
        method: 'PUT',
        path: '/panel/api/policies/overrides/:id',
        summary: 'Update an explicit override.',
        params: [{ name: 'id', in: 'path', type: 'integer' }],
        body: '{ policyId, targetType, targetRef, scope, value, priority, enabled }',
        response: 'override',
      },
      {
        ...
        summary: 'List non-expired temporary override metadata.',
        response: '{ enabled, items }',
      },
      {
        method: 'POST',
      ...
      },
      {
        ...
        summary: 'Delete a temporary override.',
        params: [{ name: 'id', in: 'path', type: 'integer' }],
      },
      {
        method: 'PUT',
      ...
      },
      {
        ...
        params: [
          { name: 'clientEmail', in: 'query', type: 'string', optional: true },
          { name: 'groupName', in: 'query', type: 'string', optional: true },
          { name: 'at', in: 'query', type: 'integer', optional: true },
        ],
        response: '{ enabled, enforcement: false, resolved }',
      },
      {
        method: 'GET',
        path: '/panel/api/policies/simulate',
        summary: 'Simulate a persisted policy decision without applying Xray changes.',
        params: [
          { name: 'clientEmail', in: 'query', type: 'string' },
          { name: 'groupName', in: 'query', type: 'string', optional: true },
          { name: 'domain', in: 'query', type: 'string', optional: true },
          { name: 'ip', in: 'query', type: 'string', optional: true },
          { name: 'category', in: 'query', type: 'string', optional: true },
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'GET',
        path: '/panel/api/traffic-control/clients/:email/policy',
        summary: 'Read fixed-window traffic policy, lifecycle, usage, and enforcement capability.',
        params: [{ name: 'email', in: 'path', type: 'string', desc: 'Client email.' }],
        response: '{ success, obj: { policy, lifecycle, usedBytes, remainingBytes, enforcement } }',
      },
      {
        method: 'PUT',
        path: '/panel/api/traffic-control/clients/:email/policy',
        summary: 'Set a fixed/tumbling-window client policy; rolling windows are unsupported.',
        params: [{ name: 'email', in: 'path', type: 'string', desc: 'Client email.' }],
        body: '{ enabled, windowSeconds, quotaBytes, activeUploadBps, activeDownloadBps, throttleUploadBps, throttleDownloadBps }',
        response: '{ success, obj: { lifecycle, enforcement, enforcementNote } }',
      },
      {
        method: 'POST',
        path: '/panel/api/traffic-control/clients/:email/policy/reset',
        summary: 'Reset the fixed-window checkpoint and release only a soft-quota throttle.',
        params: [{ name: 'email', in: 'path', type: 'string', desc: 'Client email.' }],
        response: '{ success, obj: { lifecycle, enforcement } }',
      },
    ],
  },
  ...forkApiSections,
